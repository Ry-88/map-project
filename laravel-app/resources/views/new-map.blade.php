...
<body>
  ...
  <!-- <div class="container d-flex justify-content-center">
    <div class="div-image text-center" style="width: 250px;">
    ...
    <div class="map-panel">
      ...
      <svg id="saudiMap" viewBox="0 0 1000 824">
        ...
        <g id="map-labels"
          ...
          <!-- الرياض -->
          <text x="518" y="448" font-size="20">الرياض</text>
          ...
          <!-- الشرقية -->
          <text x="698" y="452" font-size="19">الشرقية</text>

          <!-- القصيم -->
          <text x="412" y="356" font-size="17">القصيم</text>

          <!-- حائل -->
          <text x="340" y="272" font-size="17">حائل</text>

          <!-- تبوك -->
          <text x="112" y="260" font-size="17">تبوك</text>
          ...
          <!-- جازان -->
          <text x="397" y="748" font-size="13">جازان</text>

          <!-- نجران -->
          <text x="545" y="706" font-size="17">نجران</text>

          <!-- الباحة -->
          <text x="340" y="625" font-size="11">الباحة</text>

          <!-- الجوف -->
          <text x="220" y="168" font-size="16">الجوف</text>

          <!-- عسير -->
          <text x="410" y="650" font-size="15">عسير</text>
        </g>
      </svg>
